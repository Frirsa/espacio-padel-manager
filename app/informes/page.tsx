...
const horasMesAnterior =
  ...
  const clasesParaClubRealizadas =

    clasesParaClub.filter(
  ...
  const clasesPropiasIQLRealizadas =

    clasesPropiasIQL.filter(
  ...
  const totalHorasClub =
    ...
    clasesParaClubRealizadas.reduce(
  ...
  const totalHorasPropias =
    ...
    clasesPropiasIQLRealizadas.reduce(
          ...
          {tipoInforme === "iql" ? (
            ...
            <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
              ...
              <div className="rounded-2xl border border-emerald-100 bg-emerald-50/55 p-4">
                ...
                <p className="mt-1 text-xs text-emerald-900/55">{clasesParaClubRealizadas.length} clases · {totalHorasClub.toFixed(1)} h</p>
              ...
              <div className="rounded-2xl border border-rose-100 bg-rose-50/55 p-4">
                ...
                <p className="mt-1 text-xs text-rose-900/55">{clasesPropiasIQLRealizadas.length} clases · {totalHorasPropias.toFixed(1)} h</p>
